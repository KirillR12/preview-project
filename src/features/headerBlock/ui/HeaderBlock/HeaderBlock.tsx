...
className
    ...
    return (
    <HStack justify='between' max className={classNames(styles.HeaderBlock, {}, [className])}>
      <Text title='Fedotov' tag={TitleTag.H4} className={styles.text} weight='ligth'/>
...
{headerBlockData.map((el) => (
  <Button theme={ButtonTheme.CLEAR}>
      ...
      duration={700} 
    >
           <Text title={el.text} tag={TitleTag.H4} className={styles.text} weight='ligth' />
    </Link>
  </Button>
))}
<Icon Svg={darkTheme}/>
